...
export default function Cards(props) {
  ...
  const adicionarCard = (url, statusBotao) => {
    ...
    axios.post(`https://websage-api.abelcode.dev/api/save-item`, { url }, config)
      .then(async novoCard => {
        ...
        try {
          ...
          return { novoCardData, imageUrl: 'https://images.unsplash.com/photo-1557724630-96de91632c3b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w2MTg2MTd8MHwxfHNlYXJjaHwxfHx1bmRlZmluZWR8ZW58MHwwfHx8MTcxNzg2MzEzMnww&ixlib=rb-4.0.3&q=80&w=1080'};
        }
      })
  ...
  const atualizaCard = async (ramo_id, imageUrl) => {
    await axios
      .put(`https://websage-api.abelcode.dev/api/atualizar-item`, { imageUrl, ramo_id }, config).then(async (novoCard) => {
